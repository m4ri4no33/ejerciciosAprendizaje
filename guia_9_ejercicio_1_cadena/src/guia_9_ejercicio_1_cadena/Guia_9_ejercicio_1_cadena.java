...
public class Guia_9_ejercicio_1_cadena {
    ...
    public static void main(String[] args) {
        ...
        nuevo.mostrarVocales(cadena);
        nuevo.invertirFrase(cadena);
        nuevo.vecesRepetido(cadena);
        nuevo.compararLongitud(cadena);
        nuevo.unirFrases(cadena);
        nuevo.reemplazar(cadena);
        nuevo.contiene(cadena);
