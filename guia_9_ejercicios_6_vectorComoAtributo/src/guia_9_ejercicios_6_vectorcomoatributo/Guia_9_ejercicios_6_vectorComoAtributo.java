 ...
 */
package guia_9_ejercicios_6_vectorcomoatributo;
 ...
 */
public class Guia_9_ejercicios_6_vectorComoAtributo {

   
    public static void main(String[] args) {
         
        CursoServicio cursoS = new CursoServicio();
        Curso nuevo = cursoS.crearCurso();
        System.out.println("GANANCIAS "+ cursoS.calcularGananciaSemanal(nuevo));       
