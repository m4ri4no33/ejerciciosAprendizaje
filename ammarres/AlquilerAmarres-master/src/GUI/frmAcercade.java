...
public class frmAcercade extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Esta es una  aplicación  informatica que permite el alquiler");

        jLabel3.setText("de amarres para distintos tipos de barcos, ya sean veleros,");

        jLabel4.setText("barcos deportivos a motor o yates.");

        jLabel5.setText("Este sistema fue programado en el lenguaje de programación");

        jLabel10.setText("Scala y Java con un paradigma orientado a objetos.");
        ...
        jLabel9.setText("Correo electronico de contacto:");

        Enlace.setForeground(new java.awt.Color(0, 0, 102));
        Enlace.setText("daniel.gomez@ucuenca.ec");
